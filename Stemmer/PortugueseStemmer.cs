...
namespace Annytab
{
  ...
  public class PortugueseStemmer : AbstractStemmer
  {
    ...
    public PortugueseStemmer()
    {
      ...
      _endingsStep1 = new[]
                      {
                        "imentos", "uciones", "amentos", "idades", "amento", "imento", "aço~es", "adores",
                        "ância", "amente", "ências", "adoras", "logías", "aça~o", "ución", "logía", "mente", "antes",
                        "idade", "istas",
                        "ismos", "adora", "ência", "ador", "ezas", "ante", "iras", "ismo", "ivas", "osas", "osos",
                        "icas",
                        "icos", "ivos",
      ...
      _endingsStep2 = new[]
                      {
                        "íssemos", "iríamos", "ássemos", "êssemos", "eríamos", "aríamos", "ísseis", "ésseis",
                        "ásseis", "éramos", "iríeis", "eríeis", "iremos", "eremos", "aremos", "aríeis", "ávamos",
                        "íramos", "áramos", "era~o",
                        "issem", "essem", "armos", "íamos", "ara~o", "asses", "ira~o", "arias", "áveis", "ermos",
                        "irmos",
                        "assem", "ireis",
                        "íreis", "ereis", "éreis", "areis", "áreis", "iriam", "eriam", "ariam", "erias", "irias",
                        "ardes",
                        "erdes", "istes",
                        "estes", "astes", "isses", "esses", "irdes", "irás", "eres", "ares", "ires", "aram", "esse",
                        "asse", "avas", "aria",
                        "eras", "erás", "aras", "arás", "iras", "íeis", "ados", "iria", "idas", "adas", "irei", "erei",
                        "arei", "eria", "idos",
                        "ámos", "amos", "indo", "endo", "ando", "iste", "este", "emos", "imos", "aste", "irem", "erem",
                        "arem", "isse", "avam",
                        "iram", "eram", "ada", "ais", "ará", "ida", "eis", "ias", "ara", "iam", "era", "irá", "ido",
                        "ado", "ava", "ira", "erá",
    ...
    public override string GetSteamWord(string word)
    {
        ...
        switch (end)
        {
          ...
          case "mente":
            ...
            if (strR2.EndsWith(end))
            {
              ...
              if (strR2.EndsWith("ante" + end) || strR2.EndsWith("avel" + end) ||
          ...
          case "ira":
            ...
            if (strRV.EndsWith(end) && word.EndsWith("e" + end))
            {
              word = word.Remove(word.Length - end.Length);
              word += "ir";
              endingRemoved = true;
      ...
      if (endingRemoved)
      {
        if (strRV.EndsWith("i") && word.EndsWith("ci"))
      ...
      if (strRV.EndsWith("e") || strRV.EndsWith("é") || strRV.EndsWith("ê"))
      {
        word = word = word.Remove(word.Length - 1);
        strRV = partIndexR[2] < word.Length ? word.Substring(partIndexR[2]) : "";

        // If preceded by gu (or ci) with the u (or i) in RV, delete the u (or i)
        if ((word.EndsWith("gu") && strRV.EndsWith("u")) || (word.EndsWith("ci") && strRV.EndsWith("i")))
          word = word = word.Remove(word.Length - 1);
      }
