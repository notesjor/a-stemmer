...
namespace Annytab
{
  ...
  public class RomanianStemmer : AbstractStemmer
  {
    ...
    public RomanianStemmer()
    {
      ...
      _endingsStep0 = new[]
                      {
                        "iilor", "aţia", "aţie", "atei", "elor", "ilor", "iile", "ului", "iua", "aua", "ile", "ele",
                        "iei",
                        "ii", "ea", "ul"
                      };
      _endingsStep1 = new[]
                      {
                        "abilitate", "abilităţi", "ibilitate", "abilitati", "abilităi", "ivităţi", "icităţi", "ivitate",
                        "ivitati", "icitati",
                        "icatori", "icitate", "itoare", "iţiune", "ivităi", "icator", "ătoare", "icităi", "atoare",
                        "aţiune", "itori", "icală", "ativa", "icale", "icala", "itiva",
                        "icivă", "icivi", "icive", "iciva", "itive", "ative", "ativi", "ativă", "itivi", "atori",
                        "itivă",
                        "ători", "icali", "ativ", "ical", "iciv",
                        "ator", "ător", "itiv", "itor"
                      };
      _endingsStep2 = new[]
                      {
                        "ibile", "abila", "abile", "abili", "abilă", "ibila", "itati", "ibili", "ibilă", "atori",
                        "itate",
                        "ităţi", "oasă", "oasa",
                        "iuni", "abil", "ităi", "isme", "işti", "iune", "ator", "antă", "anti", "ante", "anta", "ibil",
                        "ista", "iste", "isti", "oase", "istă", "ica", "uta", "ive",
                        "ivi", "ivă", "ant", "oşi", "osi", "iva", "ata", "ism", "ist", "ică", "ici", "ice", "ată", "ate",
                        "ite", "iti", "ită", "ita", "ati", "ute", "uti", "ută", "iv",
                        "os", "ic", "it", "ut", "at"
                      };
      _endingsStep3 = new[]
                      {
                        "seserăţi", "âserăţi", "seserăm", "userăţi", "iserăţi", "aserăţi", "iserăm", "seseşi", "userăm",
                        "serăţi", "âserăm", "seseră",
                        "aserăm", "urăţi", "irăţi", "serăm", "ârăţi", "aseşi", "âseră", "useşi", "aseră", "iseşi",
                        "iseră", "useră", "ească", "âseşi", "arăţi", "sesem", "usem", "iaţi",
                        "indu", "âsem", "seră", "irăm", "ăşte", "ăşti", "sese", "isem", "urăm", "eaţi", "eşte", "eşti",
                        "arăm", "asem", "ârăm", "seşi", "ează", "ându", "âse", "use", "ând",
                        "aţi", "ind", "ise", "eţi", "âre", "iţi", "ăsc", "ase", "âţi", "âră", "ere", "âşi", "esc", "iră",
                        "işi", "ură", "sei", "uşi", "ară", "ire", "aşi", "ezi", "iau",
                        "are", "iai", "iam", "eau", "eze", "eai", "eam", "ăm", "em", "im", "âm", "âi", "ui", "ez", "ea",
                        "au", "ai", "am", "se", "ia"
                      };
