...
namespace Annytab
{
  ...
  public class DanishStemmer : AbstractStemmer
  {
    ...
    public DanishStemmer()
    {
      ...
      _validSEndings = new[]
                       {
                         'a', 'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'r', 't', 'v', 'y', 'z',
                         'å'
                       };
      _endingsStep1 = new[]
                      {
                        "erendes", "hedens", "erende", "erede", "ethed", "heden", "erens", "heder", "endes", "ernes",
                        "erets",
                        "eret", "eren", "erer", "ered", "ende", "heds", "erne", "eres", "enes", "ens", "ets", "ere",
                        "hed", "ene", "ers", "et", "er", "en",
                        "es", "e"
                      };
