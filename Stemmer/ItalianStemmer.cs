...
namespace Annytab
{
  ...
  public class ItalianStemmer : AbstractStemmer
  {
    ...
    public ItalianStemmer()
    {
      ...
      _endingsStep0 = new[]
                      {
                        "gliela", "gliele", "glieli", "glielo", "gliene", "mele", "celo", "celi", "cele", "cela",
                        "tene", "telo", "teli", "tele", "tela", "mene", "melo", "meli", "vene", "mela", "cene", "vela",
                        "vele", "veli", "velo",
                        "sene", "gli", "vi", "ti", "si", "ne", "la", "lo", "li", "le", "ci", "mi"
                      };
      _endingsStep1 = new[]
                      {
                        "atrice", "usione", "uzioni", "uzione", "azione", "amente", "imenti", "imento", "amenti",
                        "amento", "azioni", "atrici", "usioni", "abile", "abili", "ibile", "ibili", "logie", "logia",
                        "atori", "atore", "mente", "anti",
                        "ante", "enza", "anze", "enze", "ichi", "iche", "anza", "ismi", "istì", "istè", "istà", "isti",
                        "iste", "ista", "ismo", "ose", "osa",
                        "osi", "oso", "ità", "ivo", "ico", "iva", "ice", "ica", "ici", "ive", "ivi"
                      };
      _endingsStep2 = new[]
                      {
                        "irebbero", "erebbero", "eresti", "assimo", "iscono", "iranno", "iresti", "eranno", "erebbe",
                        "essero",
                        "iscano", "ireste", "assero", "eremmo", "irebbe", "ereste", "iremmo", "issero", "avamo", "avano",
                        "avate", "ivate", "ivano", "ivamo",
                        "eremo", "iremo", "erete", "erono", "evamo", "irono", "evano", "irete", "evate", "arono", "endi",
                        "irei", "irai", "ende", "immo", "iamo",
                        "Yamo", "erei", "enda", "ando", "emmo", "isca", "ammo", "asse", "isce", "isci", "erai", "isco",
                        "assi", "endo", "erà", "irà", "evo",
                        "evi", "irò", "eva", "ete", "erò", "ita", "ite", "iti", "ito", "iva", "ivi", "ere", "ivo", "ano",
                        "avo", "avi", "ono", "uta", "ute",
